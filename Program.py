            ...
            if matrix_call() == "A":                                                # First Input
                ...
                for round1 in range(1, 4):
                    ...
                    if str(list11) == data1:
                        ...
                        lcd_data(0XC0)
                        lcd_data(0X01)
                        lcd_msg("WRONG PASSWORD", "ATTEMP : "+str(round1))
                ...
                lcd_msg("A.CHANGE PASSWORD", "B.DEFAULT PASSWORD")
                input2 = matrix_call()
                flag1, flag2 = 0, 0
                if input2 == "A":
                    lcd_data(0X01)
                    print("Enter old Password")
                    lcd_msg("ENTER OLD PASSWORD")
                    ...
                    for round2 in range(1, 4):
                        ...
                        if str(list22) == data2:
                            ...
                            list22.clear()
                            print("Enter Wrong old PASSWORD")                       # print Statement
                            lcd_data(0XC0)
                            lcd_data(0X01)
                            lcd_msg("WRONG PASSWORD", "ATTEMPT :"+str(round2))      # Wrong PASSWORD lcd
                            time.sleep(1)
                            lcd_data(0X01)
                            lcd_msg("ENTER OLD PASSWORD")
                            if round2 == 3:
                                lcd_data(0X01)
                                wrong()
                                # Mail(" ALERT! SOMEONE WANT TO CHANGE YOUR PASSWORD")
                                break
